...
import { MatFormField, MatDialogModule, MAT_DIALOG_DATA, MatDialogRef } from '@angular/material';
...
@Component({
  selector: 'sims-event-set-edit-dialog',
})
export class EventSetEditDialogComponentStub {
}
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: MatDialogRef, useValue: new EventSetEditDialogComponentStub() },
      ]
    })
      .compileComponents();
  }));
