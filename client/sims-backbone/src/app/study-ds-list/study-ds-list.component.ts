...
export class StudyDsListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.downloadFileName = 'derivativeSamples_study_' + this.studyName + '.csv';
    this.jsonDownloadFileName = 'derivativeSamples_study_' + this.studyName + '.json';
  }
